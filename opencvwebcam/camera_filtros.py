...
# @interact(nucleo=kernel.keys(), limiar=(1,255,1))
# def show_convolve(nucleo, limiar=128):
nucleo = 'laplacian w/ diagonals'
limiar = 128
state = 'normal'

file = "C:\\Users\\lesly\\Documents\\LeslyMontufar.github.io\\opencvwebcam\\img\\imagem.png"
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        conv = np.uint8(np.round(convolve(gray, kernel[nucleo], fft=True)))
